...
function prepareSelectNecromancy(playerId)
  ...
  local noRestForTheWickedTaken = nil;  -- ���������� ��� ������������ ������������� "������� �������"
...
function replaceCommonUnitOnSpecial(playerId)
  ...
  if dictHeroName == HEROES.NARHIZ then
    ...
    replaceUnitInTown(MAP_PLAYER_TO_TOWNNAME[playerId], playerId, CREATURE_MAGI, 907)
    replaceUnitInTown(MAP_PLAYER_TO_TOWNNAME[playerId], playerId, CREATURE_COMBAT_MAGE, 908)
  end;
