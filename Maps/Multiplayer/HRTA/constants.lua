...
-- ������ ���� ��������� ����������
ALL_ARTS_LIST = {
  { id = 1,  level = ARTS_LEVELS.MINOR, position = ART_POSITION.WEAPON,  price = 5000 }, --��� ����
  { id = 90, level = ARTS_LEVELS.MINOR, position = ART_POSITION.WEAPON,  price = 6500 }, -- �� ����� ����������
  { id = 8,  level = ARTS_LEVELS.MINOR, position = ART_POSITION.BAG,     price = 4000 }, -- ������
  { id = 87, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BAG,     price = 6000 }, -- ������ ����
  { id = 27, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BOOTS,   price = 5000 }, -- ������ ���������� ������
  -- { id = 34, level = ARTS_LEVELS.MINOR, position = ART_POSITION.HEAD, price = 6000 }, -- ������ ��������������
  { id = 66, level = ARTS_LEVELS.MINOR, position = ART_POSITION.HEAD,    price = 6000 }, -- ���� �����
  { id = 64, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BODY,    price = 6000 }, -- ������ �� �����
  { id = 14, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BODY,    price = 5000 }, -- ��������� ����
  { id = 80, level = ARTS_LEVELS.MINOR, position = ART_POSITION.WEAPON,  price = 5000 }, -- ������� �������

  { id = 84, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BACK,    price = 4500 }, -- �������� �������
  { id = 20, level = ARTS_LEVELS.MINOR, position = ART_POSITION.RING,    price = 6000 }, -- ������ �� ������
  { id = 60, level = ARTS_LEVELS.MINOR, position = ART_POSITION.RING,    price = 5000 }, -- ���� �����������
  { id = 16, level = ARTS_LEVELS.MINOR, position = ART_POSITION.NECK,    price = 4000 }, -- ������� ����
  { id = 55, level = ARTS_LEVELS.MINOR, position = ART_POSITION.HEAD,    price = 5000 }, -- ���� ����������
  { id = 10, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BAG,     price = 5000 }, -- ������ ����
  { id = 56, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BODY,    price = 6000 }, -- ������ ����������
  { id = 85, level = ARTS_LEVELS.MINOR, position = ART_POSITION.WEAPON,  price = 6000 }, -- ������ �����
  { id = 65, level = ARTS_LEVELS.MINOR, position = ART_POSITION.RING,    price = 7000 }, -- ������ ���������������
  { id = 62, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BACK,    price = 7000 }, -- ���� �������
  { id = 93, level = ARTS_LEVELS.MINOR, position = ART_POSITION.RING,    price = 6000 }, -- ������ ��������

  -- { id = 86, level = ARTS_LEVELS.MINOR, position = ART_POSITION.BAG,  price = 6500 }, -- ���� �������
  -- { id = 61, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BOOTS,  price = 8000 }, -- ���������� �����
  -- { id = 32, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BACK,   price = 8000 }, -- ������� �������
--  { id = 70, level = ARTS_LEVELS.MINOR, position = ART_POSITION.RING,    price = 4000 }, -- ������ ���������

  { id = 31, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BACK,      price = 8000 }, -- ������� ����
  { id = 95, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BACK,      price = 8000 }, -- ������ ���������
  { id = 4,  level = ARTS_LEVELS.MAJOR, position = ART_POSITION.WEAPON,    price = 8000 }, -- ��� ���������
  { id = 63, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.RING,      price = 8000 }, --������ ������� (��������� ������)
  { id = 21, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.RING,      price = 8000 }, -- ������ ��������� ����
  { id = 25, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BAG,       price = 8000 }, -- ������� �������
  { id = 58, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.SHILD,     price = 8000 }, -- ������ ������

  -- { id = 35, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BODY,   price = 6500 }, -- �������� ��������������
  { id = 9,  level = ARTS_LEVELS.MAJOR, position = ART_POSITION.SHILD,     price = 10000 }, -- ������� ���
  { id = 88, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.HEAD,      price = 9000 }, -- ������ ���������
  { id = 41, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.HEAD,      price = 9500 }, -- ���� �������
  { id = 39, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BACK,      price = 9500 }, -- ������ �������
  { id = 5,  level = ARTS_LEVELS.MAJOR, position = ART_POSITION.WEAPON,    price = 9500 }, -- �������� �������
  { id = 18, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.NECK,      price = 9500 }, -- ������� �����
  
  { id = 81, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.WEAPON,    price = 10000 }, -- ������ �����
  { id = 2,  level = ARTS_LEVELS.MAJOR, position = ART_POSITION.WEAPON,    price = 11000 },  -- ������ ������� ������
  { id = 74, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.WEAPON,    price = 10000 }, -- ������ ����
  { id = 75, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.SHILD,     price = 10000 }, -- ��� ����

  { id = 37, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.SHILD,     price = 10500 }, -- ��� �������
  { id = 38, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BOOTS,     price = 10500 }, -- ������ �������
  { id = 82, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BODY,      price = 10000 }, -- ������ ������
  { id = 36, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.BODY,      price = 10500 }, -- ������ �������
  { id = 23, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.RING,      price = 10500 }, -- ������ ����������� ����
  { id = 19, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.NECK,      price = 10000 }, -- �������� ������
  { id = 40, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.NECK,      price = 10500 }, -- �������� �������
  { id = 45, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.WEAPON,    price = 10000 }, -- ����� ���-����
  { id = 67, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.NECK,      price = 10000 }, -- ����� ����������
  { id = 50, level = ARTS_LEVELS.MAJOR, position = ART_POSITION.HEAD,      price = 11000 }, -- ���� ������
  
  { id = 48, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BODY,      price = 12000 }, -- ������ ������
  { id = 51, level = ARTS_LEVELS.RELIC, position = ART_POSITION.SHILD,     price = 12000 }, -- ��� ������
  { id = 42, level = ARTS_LEVELS.RELIC, position = ART_POSITION.RING,      price = 12000 }, -- ������ �������
  { id = 43, level = ARTS_LEVELS.RELIC, position = ART_POSITION.WEAPON,    price = 12500 }, -- ��� �������
  { id = 17, level = ARTS_LEVELS.RELIC, position = ART_POSITION.NECK,      price = 12000 }, -- �������� ������
  { id = 59, level = ARTS_LEVELS.RELIC, position = ART_POSITION.RING,      price = 13000 }, -- ������ ���������������
  { id = 57, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BOOTS,     price = 12500 }, -- ������ ��������
  { id = 46, level = ARTS_LEVELS.RELIC, position = ART_POSITION.HEAD,      price = 12000 }, -- ������ ���-����

  { id = 68, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BOOTS,     price = 13500 }, -- ������� �������
  { id = 49, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BOOTS,     price = 13500 }, -- ������ ������
  { id = 11, level = ARTS_LEVELS.RELIC, position = ART_POSITION.HEAD,      price = 14000 }, -- ������ ����
  { id = 47, level = ARTS_LEVELS.RELIC, position = ART_POSITION.RING,      price = 14000 }, -- ������ ���-����
  { id = 7,  level = ARTS_LEVELS.RELIC, position = ART_POSITION.WEAPON,    price = 14000 }, -- ����� ����������� (������� ������������)
  { id = 33, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BACK,      price = 17000 }, -- ���� ������
  { id = 44, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BODY,      price = 17000 }, -- ����� ���-����
  { id = 71, level = ARTS_LEVELS.RELIC, position = ART_POSITION.SHILD,     price = 17000 }, -- ��� ���� (������ ����������)
  { id = 83, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BAG,       price = 18000 }, -- ����� �������
  { id = 76, level = ARTS_LEVELS.RELIC, position = ART_POSITION.SHILD,     price = 18000 }, -- ��� �����
  { id = 79, level = ARTS_LEVELS.RELIC, position = ART_POSITION.SHILD,     price = 18000 }, -- ��� �������
  { id = 77, level = ARTS_LEVELS.RELIC, position = ART_POSITION.SHILD,     price = 18000 }, -- ��� �����
  { id = 13, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BODY,      price = 22000 }, -- ������ ��������
  { id = 78, level = ARTS_LEVELS.RELIC, position = ART_POSITION.SHILD,     price = 24000 }, -- ��� ����
  -- { id = 91, level = ARTS_LEVELS.RELIC, position = ART_POSITION.RING,   price = 20000 }, -- ������ �����
  -- { id = 15, level = ARTS_LEVELS.RELIC, position = ART_POSITION.NECK,   price = 15000 }, -- ����� ����������
  -- { id = 6, level = ARTS_LEVELS.RELIC, position = ART_POSITION.WEAPON,  price = 35000 }, -- ����� �����������
  -- { id = 89, level = ARTS_LEVELS.RELIC, position = ART_POSITION.HEAD,   price = 26000 }, -- ����� ��������������
  -- { id = 69, level = ARTS_LEVELS.RELIC, position = ART_POSITION.BACK,   price = 16000 }, -- ���� ������
  -- { id = 22, level = ARTS_LEVELS.RELIC, position = ART_POSITION.RING,   price = 30000 }, -- ������ ��������
};
...
HEROES = {
  ...
  ABERRAR = 'Aberrar',                 -- ������
  VEGEYR = 'Vegeyr',                   -- ����
  RED_HEAVEN_HERO = 'RedHeavenHero03', -- �������
  ALARIC = 'Alaric',                   -- ������
  ROLF = 'Rolf',                       -- ����
  ALMEGIR = 'Almegir',                 -- �����
  MAAHIR = 'Maahir',                   -- ������
